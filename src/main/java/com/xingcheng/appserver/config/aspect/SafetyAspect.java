...
import com.xingcheng.appserver.utils.util.AesUtil;
import com.xingcheng.appserver.utils.util.ErrorUtil;
import com.xingcheng.appserver.utils.util.RsaUtil;
...
public class SafetyAspect {
     ...
     * Pointcut 切入点
     * 匹配
     * com.xingcheng.appserver.controller.*.controller、
     * com.xingcheng.appserver.*.controller包下面的所有方法
     */
    @Pointcut(value = "execution(public * com.xingcheng.appserver.controller.*.*(..)) || " +
            "execution(public * com.xingcheng.appserver.*.controller.*.*(..))")
